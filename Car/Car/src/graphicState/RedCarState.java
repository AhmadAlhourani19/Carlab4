...
public class RedCarState extends State{
	private static RedCarState instance;
	
	private RedCarState(Scene scene) {
		this.scene = scene;
	}

	public static RedCarState getInstance(Scene scene) {
		if (instance == null) {
			instance = new RedCarState(scene);
		}
		return instance;
	}
